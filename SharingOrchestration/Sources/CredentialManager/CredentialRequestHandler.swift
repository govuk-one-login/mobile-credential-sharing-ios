...
public protocol CredentialRequestHandlerProtocol {
    ...
    func signToBeSigned(in session: CryptoHolderSessionProtocol & CredentialSessionProtocol) async throws
}
...
public struct CredentialRequestHandler: CredentialRequestHandlerProtocol {
    ...
    public func signToBeSigned(in session: CryptoHolderSessionProtocol & CredentialSessionProtocol) async throws {
